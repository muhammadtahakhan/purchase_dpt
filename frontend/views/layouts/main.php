	...
	<div class="sidebar-menu">
		...
		<div class="sidebar-menu-inner">
			...
			<header class="logo-env">
				...
				<div class="logo">
					<a href="index.html">
						<img src="<?php echo Yii::getAlias('@web') ?>/design/assets/images/logo@2x.png" width="120" alt="" />
					</a>
				</div>
			...
			<div class="col-sm-9">
				...
				<div class="tile-group">
					...
					<div class="tile-left">
						...
						<div class="tile-entry">
							<img src="<?php echo Yii::getAlias('@web') ?>/design/assets/images/sample-al.png" alt="" class="pull-right op" />
						...
						<div class="tile-entry">
							<img src="<?php echo Yii::getAlias('@web') ?>/design/assets/images/sample-it.png" alt="" class="pull-right op" />
						...
						<div class="tile-entry">
							<img src="<?php echo Yii::getAlias('@web') ?>/design/assets/images/sample-au.png" alt="" class="pull-right op" />
